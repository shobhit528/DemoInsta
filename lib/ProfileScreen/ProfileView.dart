...
class ProfileView extends StatelessWidget {
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              ).textAnimate(finalColor: Colors.white),
                            ),
                          ),
                          GestureDetector(
                        ...
                        child: ListView(
                            ...
                            children: [
                              ...
                              for (var element in (profileBloc.state
                                ...
                                GestureDetector(
                                  onTap: () => profileBloc
                                      .add(HighlightsClickEvent(element.url)),
                                  child: Padding(
  ...
  Widget profielBanner({String? str}) => Container(
        constraints: BoxConstraints(
            minHeight: Get.height / 2.7,
            maxHeight: UiUtils().isWeb() ? Get.height / 1.5 : Get.height / 2.2),
        width: Get.width,
        padding: const EdgeInsets.all(10),
        child: Stack(
              ...
              Column(children: [
                Expanded(
                    ...
                    child: Container(
                      ...
                      child: Image.network(
                          "".randomImageWithOutDimention(widthScale: 2),
                          width: Get.width,
                          fit: BoxFit.fill),
                    )),
                Flexible(
                        ...
                        Expanded(
                            ...
                            child: Container(
                              ...
                              child: Column(children: [
                                Flexible(
                                  child: const Text("32k",
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              fontSize: 22))
                                      .textAnimate(finalColor: Colors.black),
                                ),
                                Flexible(
                                  child: const Text("Followers",
                                          style: TextStyle(fontSize: 20))
                                      .textAnimate(finalColor: Colors.grey),
                                )
                              ]),
                            )),
                        Expanded(
                ...
                Flexible(
                    ...
                    child: Padding(
                      ...
                      child: Column(children: [
                        Flexible(
                            child: const Text("Jenny Wilson",
                                    style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 24))
                                .textAnimate(finalColor: Colors.black)),
                        Flexible(
                            child: const Text("Sr. Product Manager",
                                    style: TextStyle(fontSize: 22))
                                .textAnimateRepeated(
                                    finalColor: Colors.grey,
                                    mediateColor: Colors.teal)),
                      ]),
                    )),
              ]),
              Positioned(
                bottom: 100,
                child: FlipCard(childWidget: profileViewImage()),
              ),
              /*Positioned(
                bottom: 220,
                top: 0,
                child: Container(color: Colors.white,width: 3,),
              ),*/
            ]),
      );
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: item.networkImage
                ? DecorationImage(image: NetworkImage(item.url!),fit: BoxFit.fitHeight)
                : DecorationImage(
  ...
  Widget customHightlightView(String? url, name, Color? color) => SizedBox(
          child: Column(
              crossAxisAlignment: CrossAxisAlignment.center,
...
extension ani on Widget {
  textAnimate({Color? finalColor}) => animate().shimmer(
      duration: 5000.ms,
      colors: [finalColor ?? AppThemeColor, Colors.green, Colors.blueGrey],
      stops: [1, 3, 5.9]);

  textAnimateRepeated({Color? finalColor, Color? mediateColor}) => animate(
        onComplete: (controller) =>controller.repeat(),
      ).shimmer(duration: 5000.ms, colors: [
        finalColor ?? AppThemeColor,
        mediateColor ?? Colors.black,
        Colors.blueGrey
      ], stops: [
        1,
        3,
